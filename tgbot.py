...
@dp.message_handler(lambda message: message.text in regions_ru.values())
async def handle_region_selection(message: types.Message):
    region_key = None
    for key, value in regions_ru.items():
    ...
    for school in schools_data:
        ...
        button = InlineKeyboardButton(text=school_name, web_app=WebAppInfo(url=web_app_url))
